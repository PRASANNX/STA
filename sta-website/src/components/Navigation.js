...
const WHATSAPP_URL = "https://wa.me/919754544265?text=Hi%20Suryansh%20Sir%2C%20I'm%20interested%20in%20STA";
    ...
    <nav className={`${styles.nav} ${scrolled ? styles.scrolled : ""}`} id="main-nav">
      <div className={styles.inner}>
        ...
        <div className={styles.actions}>
          ...
          <a href="#join" className={`btn btn-primary ${styles.ctaBtn}`}>
            Book Free Trial
          </a>
        </div>
